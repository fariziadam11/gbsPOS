...
const navItems = [
  ...
  { label: 'Fuel Reports', icon: 'pi pi-chart-bar', route: '/fuel-reports', requiresAdmin: false },
  { label: 'Fuel Prices', icon: 'pi pi-dollar', route: '/fuel-prices', requiresAdmin: true },
  { label: 'Pumps & Nozzles', icon: 'pi pi-server', route: '/pumps', requiresAdmin: true },
